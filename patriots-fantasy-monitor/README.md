...
- The ESPN panel first tries the public league feed, then the private GitHub Actions snapshot.

Open `/patriots-fantasy-monitor/` after the latest Pages deployment.
